  ...
  return (
    <section className="py-section-padding px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
        {/* Service 1 */}
        <div className="col-span-1 md:col-span-2 bg-background-2 backdrop-blur-md rounded-xl border border-white/20 shadow-sm p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
          <div>
            <span className="material-symbols-outlined text-primary text-4xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>home</span>
          ...
          <div className="mt-4">
            <span className="inline-block bg-secondary-container text-on-secondary-container px-4 py-2 rounded-full font-label-sm text-label-sm">
              Phổ biến nhất
            </span>
          </div>
        </div>
        ...
        {/* Service 2 */}
        <div className="col-span-1 bg-background-2 backdrop-blur-md rounded-xl border border-white/20 shadow-sm p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
          <div>
            <span className="material-symbols-outlined text-primary text-4xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>cleaning_services</span>
        ...
        <div className="col-span-1 bg-background-2 backdrop-blur-md rounded-xl border border-white/20 shadow-sm p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
          <div>
            <span className="material-symbols-outlined text-primary text-4xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>business</span>
        ...
        <div className="col-span-1 md:col-span-2 bg-background-2 backdrop-blur-md rounded-xl border border-white/20 shadow-sm p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
          <div>
            <span className="material-symbols-outlined text-primary text-4xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>moving</span>
