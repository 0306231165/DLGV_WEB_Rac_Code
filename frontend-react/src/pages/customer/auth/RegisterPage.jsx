...
export default function RegisterPage() {
  ...
  const handleRegisterSubmit = (e) => {
    ...
    console.log("Dữ liệu đăng ký:", { fullName, emailOrPhone, password });
  };

  return (
    /* ĐÃ SỬA: Đổi w-screen thành w-full và thêm overflow-x-hidden để chặn đứng hoàn toàn việc cuộn ngang */
    <div className="bg-surface text-on-surface font-body-md min-h-screen w-full overflow-x-hidden flex items-center justify-center relative py-12 md:py-20">
      
      {/* Block Style chứa các hiệu ứng loang và kính của bạn */}
      <style>{`
        .glass-morphism {
      ...
      {/* 1. DECORATIVE ORGANIC BACKGROUND */}
      ...
      <main className="relative z-10 w-full max-w-[1200px] flex items-center justify-center px-5 md:px-16">
        <div className="flex flex-col md:flex-row w-full bg-white/40 rounded-[32px] overflow-hidden glass-morphism shadow-2xl">
          ...
          {/* CỘT TRÁI */}
          <div className="hidden md:flex md:w-1/2 relative min-h-[650px] flex-col justify-between p-12 bg-primary overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white/60">
            <div className="mb-10 text-center md:text-left">
              ...
              <h1 className="font-h2 text-h3 md:text-h2 text-on-surface mb-2">Đăng ký</h1>
            ...
            <form className="space-y-6" onSubmit={handleRegisterSubmit}>
              ...
              <div className="space-y-2">
                <label className="block font-label-sm text-on-surface-variant" htmlFor="fullName">
                  Họ và tên
                </label>
              ...
              {/* Ô Xác nhận mật khẩu */}
              <div className="space-y-2">
                <label className="block font-label-sm text-on-surface-variant" htmlFor="confirmPassword">
                  Xác nhận mật khẩu
                </label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant/50">
            ...
            <p className="mt-10 text-center font-body-md text-on-surface-variant">
              Đã có tài khoản?{' '}
              <a className="text-primary font-bold hover:underline decoration-primary/30 underline-offset-4" href="/login">
                Đăng nhập ngay
              </a>
            </p>
          </div>
